Public Class Form_Listing_Outils_Tournage

    'Variables
    Private Num_Enreg_Actuel, Num_Enreg_Maxi_CSV As Integer
    Private Derniere_Ligne_DGV_Auto As Boolean = False
    Private Tab_Chaines(11), Type_Outil_Tournage_Principal_Local, Type_Plaq_Tournage_Principal_Local As String
    ...
    Public Sub New(Optional ByRef Bouton_Ouverture As System.Windows.Forms.Button = Nothing, _
                   ...
                   Optional ByRef Type_Outil_Tournage_Principal As String = Nothing, _
                   Optional ByRef Type_Plaq_Tournage_Principal As String = Nothing)
        ...
        'Paramètrage colonnes stock outil
        ...
        If Not Bouton_Ouverture Is Nothing And Not ComboBox_Selection Is Nothing Then
            ...
            Type_Outil_Tournage_Principal_Local = Type_Outil_Tournage_Principal
            Type_Plaq_Tournage_Principal_Local = Type_Plaq_Tournage_Principal
            ...
            Tab_Chaines(2) = Dossier_Reseau & "\Config_Outils\Fichier_Config_Outils_Tournage_Stds.csv" 'Chemin fichier de config DGV
            Tab_Chaines(3) = "Type outil standard" 'Nom colonne maîtresse fichier de config DGV
            Tab_Chaines(4) = Type_Outil_Tournage_Principal_Local 'Chaîne à rechercher dans colonne maîtresse fichier de config DGV
            Tab_Chaines(5) = "Style d'orientation" 'Nom première colonne à configurer
            Tab_Chaines(6) = "Largeur de plaquette (la)" 'Nom dernière colonne à configurer
            Tab_Chaines(7) = Dossier_Reseau & "\Config_Outils\Fichier_Config_Plaq_Tournage_Stds.csv" 'Chemin fichier de config DGV
            Tab_Chaines(8) = "Type outil standard" 'Nom colonne maîtresse fichier de config DGV
            Tab_Chaines(9) = Type_Plaq_Tournage_Principal_Local 'Chaîne à rechercher dans colonne maîtresse fichier de config DGV
            Tab_Chaines(10) = "Type" 'Nom première colonne à configurer
            Tab_Chaines(11) = "Profil de filetage" 'Nom dernière colonne à configurer
    ...
    Private Sub Form_Listing_Outils_Tournage_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) _
