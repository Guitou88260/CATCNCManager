Public Class Form_Listing_Config_Outils_Tournage_Stds
    ...
    Public Sub New(ByRef Bouton_Ouverture As System.Windows.Forms.Button)
        ...
        'Valuation variable
        Tab_Chaines(0) = Dossier_Reseau & "\Config_Outils\Fichier_Config_Outils_Tournage_Stds.csv" 'Chemin fichier
    ...
    Private Sub Form_Listing_Config_Outils_Tournage_Stds_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) _
    ...
    Private Sub DataGridView1_RowsAdded(ByVal sender As System.Object, ByVal e As DataGridViewRowsAddedEventArgs) Handles DataGridView1.RowsAdded
